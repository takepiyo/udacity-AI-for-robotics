...
class robot:
    ...
    def move(self, motion):  # Do not change the name of this function
        ...
        if beta > 0.001:
            ...
            self.x = c_x + sin(self.orientation + beta) * R
            self.y = c_y - cos(self.orientation + beta) * R
            ...
            self.orientation = (beta + self.orientation) % (2 * pi)
    ...
    def sense(self, noise_enabled=1):  # do not change the name of this function
        ...
        for landmark in landmarks:
            bearing = (
                atan2(landmark[0] - self.y, landmark[1] - self.x) - self.orientation
            )
